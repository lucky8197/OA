...
public class AccountFilter implements Filter {
	...
	// 不需要登录的 URI
	private final String[] IGNORE_URI = { "/index", "/account/validataAccount", "/account/checkLoginName", "/css/",
			"/js/", "/account/register", "/account/login", "/images", "/errorPage" };
